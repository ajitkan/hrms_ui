...
@Component({
  selector: 'app-empdeptpiechart',
  templateUrl: './empdeptchart.component.html',
  styleUrls: ['./empdeptchart.component.css']
})
export class EmpdeptchartComponent implements OnInit {
  constructor() {}
